...
class Vendors {
 static List<Vendors> vendorsListFromJson(String str) => List<Vendors>.from(json.decode(str).map((x) => Vendors.fromJson(x)));

 static String vendorsToJson(List<Vendors> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
  Vendors({
    this.user,
    this.role,
    this.store,
...
class User {
  ...
  List<dynamic> userRolesRestaurantStore;
  dynamic complaints;
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    userRolesRestaurantStore: json["userRolesRestaurantStore"] == null ? null : List<dynamic>.from(json["userRolesRestaurantStore"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "userRolesRestaurantStore": userRolesRestaurantStore == null ? null : List<dynamic>.from(userRolesRestaurantStore.map((x) => x)),
