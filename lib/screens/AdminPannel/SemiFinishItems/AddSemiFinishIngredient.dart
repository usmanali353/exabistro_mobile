...
class AddSemiFinishIngredient extends StatefulWidget {
  var storeId,semiFinishId;


  AddSemiFinishIngredient(this.storeId,this.semiFinishId);
...
class _add_CategoryState extends State<AddSemiFinishIngredient> {
  String token;
  File _image;
  var picked_image;
  var responseJson;
                ...
                InkWell(
                  onTap: (){
                    if(quantity.text==null){
                      ...
                      Utils.showError(context, "Stock Required");
                    }
                    else{
                      Utils.check_connectivity().then((result){
                        if(result){
                          networksOperation.addSemiFinishIngredient(context, token, SemiFinishedItemIngredient(
                            stockItemId: selectedStock.id,
                            sizeId: selectedSize.id,
                            quantity: double.parse(quantity.text),
                            semiFinishedItemId: widget.semiFinishId,
