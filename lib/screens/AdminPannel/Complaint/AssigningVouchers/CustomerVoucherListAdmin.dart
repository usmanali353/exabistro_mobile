...
class CustomerVoucherList extends StatefulWidget {
  ...
  CustomerVoucherList(this.complaint);
...
class _TaxListState extends State<CustomerVoucherList>{
  String token;
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=> AddCustomerVoucher(widget.complaint)));
              },
            ),
          ],
                        ...
                        secondaryActions: <Widget>[
                          IconSlideAction(
                            ...
                            onTap: () async {
                              ...
                              Navigator.push(context,MaterialPageRoute(builder: (context)=>UpdateCustomerVoucher(voucherList[index])));
                            },
                          ),
                        ],
                        child: Padding(
