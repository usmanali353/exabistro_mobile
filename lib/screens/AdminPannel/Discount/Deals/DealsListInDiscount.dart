...
class _DiscountItemsListState extends ResumableState<DealsList> {
        ...
        child: Container(
            ...
            child: ListView(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(15.0),
                  child: Text("Price Range",style: TextStyle(color: yellowColor,fontSize: 23, fontWeight: FontWeight.bold)),
                ),
                Padding(
...
//                                  },
      ...
      body: RefreshIndicator(
        ...
        child: Container(
          ...
          child: isListVisible==true&&dealsList!=null&&dealsList.length>0? new Container(
                  ...
                  return Padding(
                    ...
                    child: Slidable(
                      ...
                      secondaryActions: <Widget>[
                        ...
                        IconSlideAction(
                          icon: dealsList[index]['isVisible']?Icons.visibility_off:Icons.visibility,
                          color: Colors.red,
                          caption: dealsList[index]['isVisible']?"InVisible":"Visible",
                          onTap: () async {
                          networksOperation.deleteDeal(context, token,dealsList[index]['id']).then((value) {
                            if(value!=null){
                              WidgetsBinding.instance
                                  .addPostFrameCallback((_) => _refreshIndicatorKey.currentState.show());
                            }
                      ...
                      child: InkWell(
                        onTap: () {
                          print(dealsList[index]);
                          Navigator.push(context, MaterialPageRoute(builder: (context) => DealDetails(dealsList[index]['productDeals'])));
                        },
                        child: Card(
                          elevation: 8,
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              //color: Colors.white,
                              color: dealsList[index]['isVisible']?BackgroundColor:Colors.grey.shade300,
                              borderRadius: BorderRadius.circular(8),
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  '${dealsList[index]['startDate']!=null?dealsList[index]['startDate'].toString().substring(0,10):""}',
                                                  //${dealsList[index]['startDate'].toString().substring(0,10)}
                                                  style: TextStyle(
                                                    color: Colors.grey,
                                                    fontSize: 17,
                                                    fontWeight: FontWeight.w500,
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  '${dealsList[index]['endDate']!=null?dealsList[index]['endDate'].toString().substring(0,10):""}',
                                                  //${dealsList[index]['endDate'].toString().substring(0,10)}
                                                  style: TextStyle(
                                                    color: Colors.grey,
                                                    fontSize: 17,
                                                    fontWeight: FontWeight.w500,
          ...
          ):isListVisible==true&&dealsList!=null&&dealsList.length==0?Center(
              child:Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Container(
