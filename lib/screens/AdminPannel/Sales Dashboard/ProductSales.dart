...
class ProductSales extends StatefulWidget {
  ...
  ProductSales(this.storeId);

  @override
  _ProductSalesState createState() => _ProductSalesState();
}

class _ProductSalesState extends State<ProductSales> {
  final GlobalKey<RefreshIndicatorState> _refreshIndicatorKey = GlobalKey<RefreshIndicatorState>();
  List<SalesByProduct> sales=[];
    ...
    return Scaffold(
        ...
        body: RefreshIndicator(
          ...
          onRefresh: (){
            ...
            return networksOperation.getSalesByProducts(context, DateFormat("MM/dd/yyyy").format(startDate), DateFormat("MM/dd/yyyy").format(endDate), widget.storeId).then((value) {
              setState(() {
                isListVisible=true;
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child:
                                Center(
                                  child: Text(sales[index].category.toString(),
                                    style: TextStyle(
                                        fontSize: 18,
                                        color: PrimaryColor,
                                        fontWeight: FontWeight.bold
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child:
                                Center(
                                  child: Text(sales[index].itemSold.toString(),
                                    style: TextStyle(
                                        fontSize: 18,
                                        color: PrimaryColor,
                                        fontWeight: FontWeight.bold
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child:
                                Center(
                                  child: Text(sales[index].grossProfit.toStringAsFixed(1),
                                    style: TextStyle(
                                        fontSize: 18,
                                        color: PrimaryColor,
                                        fontWeight: FontWeight.bold
