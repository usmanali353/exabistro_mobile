...
class AddStockRecovery extends StatefulWidget {
  var token;int stockDetailId;

  AddStockRecovery(this.token,this.stockDetailId); // var product_id;
  @override
...
class _add_SizesState extends State<AddStockRecovery> {
  String token;
                    ...
                    onTap: (){
                      if (!_formKey.currentState.validate()) {
                        ...
                        Utils.check_connectivity().then((result){
                          if(result){
                            networksOperation.addRecoveryRequest(context, token,StockRecovery(
