...
class UpdatePurhaseOrder extends StatefulWidget {

  UpdatePurhaseOrder({Key key,this.storeId,this.token,this.Id}) : super(key: key);
  var storeId,token,Id;

  @override
  _AddProductIngredientState createState() => _AddProductIngredientState();
}

class _AddProductIngredientState extends State<UpdatePurhaseOrder> {
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: (){
                      ...
                      networksOperation.updatePurchaseOrder(context, widget.token, PurchaseOrder(
                          id: widget.Id,
                          createdBy: 1,
                          createdOn: DateTime.now(),
                          storesId: widget.storeId,
