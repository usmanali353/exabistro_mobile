...
class AddStocks extends StatefulWidget {
  ...
  AddStocks(this.storeId,this.token); // var product_id;
  @override
...
class _add_SizesState extends State<AddStocks> {
  String token;
  TextEditingController name, price,quantity,minQuantity,maxQuantity,perUnitWaste;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Add Inventory", style: TextStyle(
                  ...
                  InkWell(
                    onTap: (){
                      if (!_formKey.currentState.validate()) {
                        ...
                        List<StockVendors> stockVendors=[];
                        // stockVendors.add(StockVendors(
                        //     stockItemId: 0,
                        //     days: 1,
                        //     hours: 0,
                        //     vendorId: selectedVendor.userId,
                        //     isVisible: true,productQuality: 1,
                        //     createdBy: 1,
                        //     createdOn: DateTime.now()
                        // ));
                        var data= StockItems.StockItemsToJson(StockItems(
                        ...
                        Utils.check_connectivity().then((result){
                          if(result){
                            networksOperation.addStockItem(context, token,data).then((value) {
                              if(value){
