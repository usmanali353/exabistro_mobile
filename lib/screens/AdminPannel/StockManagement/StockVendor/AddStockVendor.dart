...
class AddStockVendors extends StatefulWidget {
  var token,storeId;
  StockItems stockItem;
  AddStockVendors(this.storeId,this.stockItem,this.token); // var product_id;
  @override
...
class _add_SizesState extends State<AddStockVendors> {
  String token;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Add Product Vendor", style: TextStyle(
                  ...
                  InkWell(
                    onTap: (){
                      if (!_formKey.currentState.validate()) {
                        ...
                        var data= StockVendors.stockVendorsToJson(StockVendors(
                    createdOn: DateTime.now(),
                        ...
                        Utils.check_connectivity().then((result){
                          if(result){
                            networksOperation.addVendorByStockId(context, token,data).then((value) {
                              if(value){
                                Navigator.pop(context);
                                Utils.showSuccess(context, "Vendor Successfully Added");
                              }else{
