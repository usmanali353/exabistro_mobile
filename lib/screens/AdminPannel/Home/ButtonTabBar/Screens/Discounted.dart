...
class Discounted extends StatefulWidget {
  var storeId;

  Discounted(this.storeId);

  @override
  _PastOrdersState createState() => _PastOrdersState();
}
class _PastOrdersState extends State<Discounted> {
  String token;
              ...
              setState(() {
                ...
                if(value!=null) {
                  for (int i = 0; i < value.length; i++) {
                    if (value[i]['discountedPrice'] != null&&value[i]['discountedPrice']>0){
