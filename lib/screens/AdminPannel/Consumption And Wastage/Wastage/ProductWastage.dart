...
class ProductWastage extends StatefulWidget {
 Products product;

 ProductWastage(this.product);

  @override
  _ProductWastageState createState() => _ProductWastageState();
}

class _ProductWastageState extends State<ProductWastage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title:Text(widget.product.name+" "+"Wastage",style: TextStyle(
              color: yellowColor,
              fontSize: 20
          ),),
          centerTitle: true,
        ...
        body: RefreshIndicator(
          ...
          onRefresh: (){
            return Utils.check_connectivity().then((value){
              if(value){
                networksOperation.getProductWastageByDates(context,DateFormat("MM/dd/yyyy").format(startDate), DateFormat("MM/dd/yyyy").format(endDate),widget.product.id).then((value){
                  setState(() {
                      ...
                      Center(
                        child: JsonTable(
                          ...
                          columns: [
                            ...
                            JsonTableColumn("size", label: "Size"),
