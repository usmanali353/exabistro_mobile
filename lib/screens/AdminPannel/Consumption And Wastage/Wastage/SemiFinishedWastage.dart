...
class SemifinishedItemWastage extends StatefulWidget {
  SemiFinishItems semiFinishItems;

  SemifinishedItemWastage(this.semiFinishItems);

  @override
  _SemifinishedItemWastageState createState() => _SemifinishedItemWastageState();
}

class _SemifinishedItemWastageState extends State<SemifinishedItemWastage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title:Text(widget.semiFinishItems.itemName+" "+"Wastage",style: TextStyle(
              color: yellowColor,
              fontSize: 20
          ),),
          centerTitle: true,
          ...
          onRefresh: (){
            return Utils.check_connectivity().then((value){
              if(value){
                ...
                networksOperation.getSemiFinishedWastageByDates(context,DateFormat("MM/dd/yyyy").format(startDate), DateFormat("MM/dd/yyyy").format(endDate),widget.semiFinishItems.id).then((value){
                  setState(() {
