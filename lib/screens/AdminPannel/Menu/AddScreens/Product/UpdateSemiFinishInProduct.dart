...
class UpdateSingleSemiFinishInProduct extends StatefulWidget {
  var storeId;
  Products productObj;
  SemiFinishedInProduct semiFinishDetail;


  UpdateSingleSemiFinishInProduct(this.storeId,this.productObj,this.semiFinishDetail);
...
class _add_CategoryState extends State<UpdateSingleSemiFinishInProduct> {
  String token;
  File _image;
  var picked_image;
  var responseJson;
...
//  _add_CategoryState(this.token);
  ...
  @override
  void initState(){
    print(widget.semiFinishDetail.quantity);
    ...
    SharedPreferences.getInstance().then((value) {
      setState(() {
        ...
        quantity.text = widget.semiFinishDetail.quantity.toString();
                ...
                InkWell(
                  onTap: (){
                    if(quantity.text==null){
                      ...
                      Utils.check_connectivity().then((result){
                        if(result){
                          networksOperation.updateSemiFinishInProduct(context, token, SemiFinishedInProduct(
                              id: widget.semiFinishDetail.id,
