...
class UpdatePriority extends StatefulWidget {
  var priorityDetail,storeId;

  UpdatePriority(this.priorityDetail,this.storeId); // var product_id;
  @override
...
class _AddPriorityState extends State<UpdatePriority> {
  String token;
  ...
  void initState(){
    ...
    SharedPreferences.getInstance().then((value) {
      setState(() {
        ...
        name.text = widget.priorityDetail['name'];
        price.text = widget.priorityDetail['percentage'].toString();
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Update Priority", style: TextStyle(
              ...
              children: <Widget>[
                ...
                InkWell(
                  onTap: (){
                    ...
                    // else if(widget.priorityDetail['priority']==null){
                    //   Utils.showError(context, "Priority Required");
                    //
                    // }
                    else{
                      Utils.check_connectivity().then((result){
                        if(result){
                          var data ={
                            "Id": widget.priorityDetail['id'],
                            "Name": name.text,
                            "Priority": widget.priorityDetail['priority'],
