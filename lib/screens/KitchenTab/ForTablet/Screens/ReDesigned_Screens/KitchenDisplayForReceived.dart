...
class KitchenDisplayForReceived extends StatefulWidget {

  var storeId;

  KitchenDisplayForReceived(this.storeId);


  @override
  State<KitchenDisplayForReceived> createState() => _KitchenDisplayForReadyState();
}

class _KitchenDisplayForReadyState extends State<KitchenDisplayForReceived> {
