...
class KitchenOrderDetailPagePreparing extends StatefulWidget {
  var Order;

  KitchenOrderDetailPagePreparing({this.Order});

  @override
  _OrderDetailPageState createState() => _OrderDetailPageState();
}

class _OrderDetailPageState extends State<KitchenOrderDetailPagePreparing>{
  // List<Sizes> sizes =[];
  List sizes = [];
  String token;
                                ...
                                child: Slidable(
                                  ...
                                  secondaryActions: <Widget>[
                                    IconSlideAction(
                                      ...
                                      caption: 'Prepare',
                                      onTap: () async {
                                        if(itemsList[index]['orderItemStatus']==0){
                                          networksOperation.changeOrderItemStatus(context, token, itemsList[index]['id'], 1,userId).then((value) {
                                            if(value!=null){
                                    ...
                                    IconSlideAction(
                                      ...
                                      caption: 'Done',
                                      onTap: () async {
                                        if(itemsList[index]['orderItemStatus']==1){
                                          networksOperation.changeOrderItemStatus(context, token, itemsList[index]['id'], 2,userId).then((value) {
                                            if(value!=null){
