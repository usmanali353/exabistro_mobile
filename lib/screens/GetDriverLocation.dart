...
//     _getCurrentLocation();
//     backgroundLocationFetch = Geolocator().getPositionStream(LocationOptions(accuracy: LocationAccuracy.high,distanceFilter: 100,timeInterval: 5000)).listen((event) {
//       networksOperation.updateDriverLocation(context, token,orderList[index]['id'],orderList[index]['driverId']
//           ,"currentAddress",event.latitude.toString(),event.longitude.toString()).then((value){
//         if(value)   {
