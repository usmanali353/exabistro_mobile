...
import 'package:capsianfood/screens/CutomerPannel/MostFavouritesTabs/ForMobile/Screens/GetTrendingByCustomer.dart';
...
class MostFavouritesScreenTab extends StatefulWidget {
  var token,userId;

  MostFavouritesScreenTab(this.token,this.userId);
...
class KitchenWidgetState extends State<MostFavouritesScreenTab> with SingleTickerProviderStateMixin{
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(children: [
            FavouriteItemsList(widget.token,widget.userId),
            TrendingByCustomer(),
          ]),
        )
    );
