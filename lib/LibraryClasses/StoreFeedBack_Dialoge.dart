...
class _RatingDialogState extends State<StoreFeedBackDialog> {
                ...
                FlatButton(
                  ...
                  onPressed: () {
                    if(widget.uId!=null){
                      ...
                      networksOperation.updateStoreFeedback(context, widget.token, reviewsData).then((value) {
                        if(value!=null){
                      ...
                      networksOperation.addStoreFeedBack(context, widget.token, reviewsData).then((value) {
                        if(value!=null){
                          Navigator.pop(context);
                          Navigator.of(context).pop();
                        }
...
class StoreFeedBackDialog extends StatefulWidget {
  var storeId,customerId,token,uId;
  final String title;
