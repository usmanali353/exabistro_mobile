...
class _RatingDialogState extends State<FeedBackDialog> {
                ...
                FlatButton(
                  ...
                  onPressed: () {
                    if(widget.uId!=null){
                      ...
                      networksOperation.updateFeedback(context, widget.token, reviewsData).then((value) {
                        if(value!=null){
                      ...
                      networksOperation.addFeedBack(context, widget.token, reviewsData).then((value) {
                        if(value!=null){
                          Navigator.pop(context);
                          Navigator.of(context).pop();
                        }
