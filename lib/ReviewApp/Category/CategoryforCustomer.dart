...
import 'SubCategoryforCustomer.dart';



class ReviewCategoryCustomerList extends StatefulWidget {
  var storeId;

  ReviewCategoryCustomerList(this.storeId);
...
class _categoryListPageState extends State<ReviewCategoryCustomerList>{
  String token;
        ...
        body: RefreshIndicator(
          ...
          onRefresh: (){
            return Utils.check_connectivity().then((result){
              if(result){
                ReviewNetworks().getCategoriesforCustomer(widget.storeId,context).then((value){
                  setState(() {
                        ...
                        child: Slidable(
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ReviewSubCategoryCustomerList( widget.storeId,categoryList[index].id,),));
                            },
                          ),
                        ),
                      ),
