...
class addReviewSubCategory extends StatefulWidget {
int categoryId,businessId;

addReviewSubCategory(this.businessId,this.categoryId);
...
class _add_SubcategoryState extends State<addReviewSubCategory> {
  int categoryId;
                  ...
                  onTap: (){
                    ...
                    if(name.text==null||name.text.isEmpty){
                      ...
                      Utils.check_connectivity().then((result){
                        if(result){
                          ReviewNetworks().addSubCategories(CategoriesViewModel(
